...
const slides = [
  {
    title: 'Bienvenido a QwenProxy V2',
    description: 'Tu proxy inteligente para gestionar múltiples cuentas de Qwen Web con rotación automática y control total.',
    icon: (
  ...
  {
    title: 'Gestión Inteligente de Cuentas',
    description: 'Agrega múltiples cuentas, monitorea cuotas y uso de tokens en tiempo real, y permite que el sistema alterne automáticamente cuando sea necesario.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" className="text-primary">
  ...
  },
  {
    ...
    description: 'API drop-in compatible con clientes OpenAI. Simplemente apunta a la dirección del proxy y usa tu clave de acceso local.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" className="text-primary">
